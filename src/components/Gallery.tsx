      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Photo
            <span className="bg-gradient-to-r from-emerald-600 to-blue-600 bg-clip-text text-transparent"> Gallery</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Immerse yourself in the breathtaking beauty of Sri Lanka through our collection 
          ...
          {images.map((image, index) => (
            <div
              ...
              className={`group relative overflow-hidden rounded-2xl cursor-pointer transform hover:scale-105 transition-all duration-500 hover:shadow-2xl ${
                index % 8 === 0 || index % 8 === 3 ? 'lg:col-span-2 lg:row-span-2' : ''
                ...
                <div className="relative">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-8 text-white rounded-b-lg">
                    ...
                    <div className="flex items-center space-x-3 text-lg">
                      ...
                      <span>{images.find(img => img.id === selectedImage)!.location}</span>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-emerald-50 to-blue-50 rounded-2xl p-8 mb-8">
            ...
            <p className="text-gray-600 mb-6">
              Follow us on social media for daily Sri Lankan beauty and travel inspiration.
            </p>
            <div className="flex justify-center space-x-4">
              ...
              <button className="bg-red-600 text-white px-6 py-3 rounded-full font-semibold hover:bg-red-700 transition-colors flex items-center space-x-2">
                <span>YouTube</span>
              </button>
            </div>
          </div>
